 ...
 * @Version 1.0
 */
public class User implements InitializingBean, DisposableBean, BeanFactoryAware, ApplicationContextAware {
    private String name;
    private Org org;

    private BeanFactory beanFactory;

    private AllInOneApplicationContext applicationContext;
    ...
    @Override
    public void setApplicationContext(AllInOneApplicationContext applicationContext) throws BeansException {
