...
//        setEnvironment(environment);
    ...
    public Set<BeanDefinition> doScan(String[] basePackages) {
        ...
        bd.setBeanClass("com.maoyou.springframework.beans.factory.annotation.AutowiredAnnotationBeanPostProcessor");
        registry.registerBeanDefinition("com.maoyou.springframework.beans.factory.annotation.AutowiredAnnotationBeanPostProcessor", bd);
